...
<section class="riwayatph" style="display: flex; flex-wrap: wrap;
    gap: 25px;
    width: 80%;
    margin: auto;">
    <div class="kebutuhan_tujuan" style=" margin: auto;
    margin-bottom: 100px;">
        <div class="kebutuhan" style="background-color: white;
    ...
    border-radius: 10px;">
            ...
            <form action="page.php" method="post">
                ...
                <input style="margin-bottom: 10px; width: 200px; " type="number" name="uang_masuk" id="uang_masuk"></td></tr>
                <tr><td ><label for="pengeluaran">pengeluaran:</label></td><td>
                <input style="margin-bottom: 10px; width: 200px;" type="number" name="uang_keluar" id="uang_keluar"></td></tr>
                
                <tr><td ><label for="ket_uang">keterangan:</label></td><td>
                <input style="margin-bottom: 10px; width: 200px;" type="text" name="ket_uang" id="keterangan_uang" placeholder="example: beli sapu dan dapat uang hilang"></td></tr>
    ...
    <div class="aktivitas" style="text-align: left;">
        <h2 style="margin-bottom: 30px; margin-left: 30px;">riwayat uang kas</h2>
        <div class="riwayat" style=" width: 320px;
    height: 180px;
    display: grid;
    ...
    gap: 10px;">
            ...
            while ($row = $result2->fetch_assoc()) {
                echo "<div class='perTanggal' style='background: #fee2e2;
    box-shadow: 2px 2px 5px rgba(0,0,0,0.05);
    padding: 10px;
    border-radius: 10px;
    text-align: center;'>";
